		...
		>
			<View className="flex-row items-center">
				...
				<View className="flex-1">
					...
					{user.distanceInfo ? (
						<View>
							<Text className="text-sm font-medium text-blue-600">{user.distanceInfo.distance}</Text>
							<Text className="text-xs text-gray-500">{user.distanceInfo.duration}</Text>
						</View>
					) : (
						<Text className="text-sm font-semibold text-gray-500">{locationText}</Text>
					)}
				</View>
