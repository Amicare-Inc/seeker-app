      ...
      >
        ...
        >
          <View className="flex-1 flex-row items-center justify-center">
            ...
            <Text className="text-sm text-white ml-2">{dateLabel}</Text>
            <Text className="text-xs text-green-400 ml-2">{`${isNextDay? '+1':""}`}</Text>
          </View>
          <View style={{ width: 1, height: 28, backgroundColor: "rgba(255,255,255,0.5)" }} />
          <View className="flex-1 flex-row items-center justify-center">
            <Ionicons name="time" size={18} color="#ffffff" />
            <Text className="text-sm text-white ml-2">{timeRange}</Text>
          </View>
        </View>
        ...
        <View className="flex-row items-center justify-between mb-4">
          <TouchableOpacity
            ...
            style={{ width: "48%" }}
          >
            <Text className="text-black text-sm text-center">Accept</Text>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            style={{ width: "48%" }}
          >
            <Text className="text-white text-sm text-center">Reject</Text>
          </TouchableOpacity>
        </View>

        {/* Status & Total Cost Row */}
        <View className="flex-row items-center justify-between mb-3">
          <Text className="text-xs text-white">Awaiting confirmation</Text>
        ...
        >
          <Text className="text-white text-sm">Request Date/Time Change</Text>
        </TouchableOpacity>
      </LinearGradient>
    </View>
  );
