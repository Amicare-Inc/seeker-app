...
const DatePickerField: React.FC<DatePickerFieldProps> = ({ title, value, onDateChange, otherStyles }) => {
  ...
  return (
    <View className={otherStyles}>
      <TouchableOpacity onPress={() => setDatePickerVisibility(true)} activeOpacity={0.9}>
