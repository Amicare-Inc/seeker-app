...
const UserCardExpanded: React.FC<UserCardExpandedProps> = ({ user, onClose }) => {
    ...
    >
      <View pointerEvents="box-none">
        ...
        <View className="flex-row items-center justify-between mb-4">
          ...
          <Text className="font-bold text-base text-black">${rate.toFixed(2)}</Text>
        </View>
        ...
        {/* Skill Sets */}
        <Text className="font-bold text-gray-800 mb-1">My Skill Set</Text>
        <Text className="text-gray-700 mb-3">{tasks}</Text>

        {/* Diagnosed Conditions */}
        <Text className="font-bold text-gray-800 mb-1">Diagnosed conditions I have cared for</Text>
        ...
        <View className="flex-row mt-4" pointerEvents="box-none">
          ...
          >
            <Text className="text-white font-bold">Request Session</Text>
          </TouchableOpacity>
          {/* More Info Button */}
          <TouchableOpacity
            onPress={(e) => {
