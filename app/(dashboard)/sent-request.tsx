    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="flex-1 justify-center items-center px-4">
        ...
        <View className="flex-row items-center mb-2">
          ...
          <Text className="text-lg font-semibold ml-2">Session Request Sent!</Text>
        </View>

        {/* Subtext about card being charged */}
        <Text className="text-sm text-gray-500 text-center mb-6">
          You have successfully sent a request to {otherUser?.firstName}. You can start chatting once they accept your request.
        </Text>
