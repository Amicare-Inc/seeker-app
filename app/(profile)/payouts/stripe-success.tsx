...
const StripeSuccessPayouts: React.FC = () => {
	...
	const handleTryAgain = () => {
		router.replace('/(profile)/payouts/stripe-onboarding');
	};
					...
					<>
						<View className="items-center mb-8">
							...
							<Text className="text-gray-600 text-center text-base leading-6">
								Your Stripe account has been successfully configured. You're now ready to receive payments.
							</Text>
						</View>
						<CustomButton
...
export default StripeSuccessPayouts; 