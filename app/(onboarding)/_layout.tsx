...
const OnboardingLayout = () => {
  return (
    <Stack>
      ...
      <Stack.Screen name="add_profile_photo" options={{headerShown:false}}/>
      <Stack.Screen name="verification_prompt" options={{headerShown:false}}/>
      <Stack.Screen name="verification_webview" options={{headerShown:false}}/>
