  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', alignItems: 'center' }}>
        <Text className="text-3xl text-black font-normal mb-3">Verify Your Identity</Text>
        <Text className="text-sm text-gray-500 font-normal mb-6 text-center">
          For security purposes, we need to verify your identity. You may skip this for now and do it later.
        </Text>
      </ScrollView>
