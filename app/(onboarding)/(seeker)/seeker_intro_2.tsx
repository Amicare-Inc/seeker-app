            ...
            <ScrollView contentContainerStyle={{ height: '100%' }}>
                <View className="flex w-full h-full justify-center items-center p-4">
                    ...
                    <Text className="text-xs text-gray-500 font-normal text-left mb-4">
                        ...
                        Timely communication is vital, especially if there has been a change in plans or 
                        issues with the SupportLink app. In emergencies requiring shift cancellations, 
                        notify us at least 24 hours in advance.  Note, last-minute cancellations incur 
